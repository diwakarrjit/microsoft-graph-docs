...
The **groupPeerOutlierRecommendationInsightSettings** allows you to configure group peer outlier insights to aid reviewers to make decisions for an [accessReviewScheduleDefinition](accessreviewscheduledefinition.md) object.
